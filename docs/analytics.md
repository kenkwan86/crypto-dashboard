...
Daily mean of five clipped [-3,3] components: median funding z90, median
7d-OI-change z90, median 30d-return z90, breadth ((% coins above 50d MA - 0.5) * 4),
BTC DVOL 1y rolling percentile rescaled the same way. Positive = crowded/hot.
